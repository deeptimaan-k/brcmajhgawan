...
import { schoolNavigation } from '../../data/schoolNavigation';
import { useAuth } from '../../hooks/useAuth';

interface SchoolDashboardSidebarProps {
  isOpen: boolean;
  onClose: () => void;
}

export function SchoolDashboardSidebar({ isOpen, onClose }: SchoolDashboardSidebarProps) {
